    ...
    layout = html.Div(
        ...
        children=[
            ...
            html.Div([
                ...
                html.P(html.I(children=[html.Span('Any questions or suggestions, please contact me at '), html.Strong('tduongcs [at] gmail [dot] com'), html.Br()]))
            ]),
            html.Br(),
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([dcc.Graph(id="state_new_case_plot",
